    ...
    (function() {
        function c() {
            ...
            if (b) {
                ...
                d.innerHTML =
                    "window.__CF$cv$params={r:'95e2fa11bb956dbe',t:'MTc1MjM0ODg1NC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";
